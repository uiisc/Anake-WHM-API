<?php
namespace Tests\Unit\AnakeClient\Message;

use GuzzleHttp\Psr7\Response;
use HansAdema\AnakeClient\Message\GetUserDomainsRequest;
use HansAdema\AnakeClient\Message\GetUserDomainsResponse;
use HansAdema\AnakeClient\Tests\Message\RequestTestCase;
...
class GetUserDomainsRequestTest extends RequestTestCase {
    ...
    protected function assertValidGetCall($function) {
        ...
        $this->assertEquals($this->defaultParameters['apiUrl'].$function.'?'.http_build_query($this->request->getData()), (string)$request->getUri());
    }
}