<?php
namespace HansAdema\AnakeClient\Tests\Message;

use GuzzleHttp\Psr7\Response;
use HansAdema\AnakeClient\Message\AvailabilityRequest;
use HansAdema\AnakeClient\Message\AvailabilityResponse;
...
class AvailabilityRequestTest extends RequestTestCase {
    ...
    public function testSendSuccessful() {
        ...
        $this->assertEquals($this->defaultParameters['apiUrl'].'checkavailable?'.http_build_query($this->request->getData()), (string)$request->getUri());
    }
